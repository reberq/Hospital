  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      <section>
          ...
          <form class="form-wrapper" action='modificarCita.php' method='POST'>
      ...
      <div class="row">
        <div class="col sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="./modificarCita.php"><i class="fa fa-calendar-check-o fa-fw"></i> Modificar cita</a></li>
            ...
            <div class="row justify-content-md-center" id="div_resultado">
              <div class="col-md-12">
                <div class="well well-sm" id="well2">
                  <form class="form-horizontal" name="form" action="../logica/modificaCita.php?id=<?php echo $valor?>" method="POST">
                    <fieldset>
                      
                      <legend class="text-center header"> Modificar cita</legend>

                      <div class="form-group">
                        <div class="col-md-8">
                          <input id="fecha" name="fecha" type="date" placeholder="Fecha" value="<?php echo $fila[0]?>" class="form-control" required="required" >
                        </div>
                      </div>
                      <div class="form-group">
                        <div class="col-md-8">
                          <input id="hora" name="hora" type="time" placeholder="Hora" value="<?php echo $fila[1]?>" class="form-control" required="required">
                        </div>
                      </div>
